    ...
    this.container.innerHTML = `
      <div class="header">
        <div class="header-left">
          ...
          ${import.meta.env.VITE_FOCUS_PARIS === 'true' ? `
            <button class="variant-btn active" id="parisVariantBtn" title="PARIS SENTINEL EDITION">
              <span class="variant-label">🌆 PARIS</span>
            </button>
          ` : `
